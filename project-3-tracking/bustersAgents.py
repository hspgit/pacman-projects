...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState: busters.GameState):
        ...
        for beliefDist in livingGhostPositionDistributions:
            mostLikelyPosition = beliefDist.argMax()
            mostLikelyGhostPositions.append(mostLikelyPosition)
        
        # Step 2: Find the closest ghost (by maze distance)
        if not mostLikelyGhostPositions:
            # No ghosts left, just return a random legal action
        ...
        # Step 3: Choose the action that minimizes distance to closest ghost
        bestAction = None
        ...
        for action in legal:
            ...
            # Calculate distance from successor to closest ghost
